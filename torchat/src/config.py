...
config_defaults = {
    ...
    ("files", "dragdropzipdir_enable") : 0,
    ("files", "dragdropzipdir_packer") : "c:/Program Files/WinRAR/Rar.exe",
    ("files", "dragdropzipdir_command") : 'call "%s" a -r -ep1 "%s" "%s";',
    ("files", "dragdropzipdir_wipezip") : 0,
    ("files", "reconnect_on_timeout") : 0,
